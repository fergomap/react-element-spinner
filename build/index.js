...
})(exports.SpinnerPositionEnum || (exports.SpinnerPositionEnum = {}));
...
})(exports.SpinnerTypeEnum || (exports.SpinnerTypeEnum = {}));

const getSpinnerFontSizeAspectRatio = (spinnerType) => {
    switch (spinnerType) {
        case exports.SpinnerTypeEnum.CIRCLE_DOTS:
            return SPINNER_CONSTANTS.ASPECT_RATIO.CIRCLE_DOTS;
        case exports.SpinnerTypeEnum.CIRCLE_DOTS_COLLAPSE:
...
const isDefaultSpinner = (spinnerType) => {
    return !spinnerType || spinnerType === exports.SpinnerTypeEnum.DEFAULT;
};
...
class SpinnerComponent extends React.Component {
    ...
    componentDidMount() {
        this.setUpSpinner();
        if (this.props.resize && this.props.position === exports.SpinnerPositionEnum.CENTERED) {
    ...
    setUpSpinner() {
        ...
        if (this.props.position === exports.SpinnerPositionEnum.CENTERED) {
        ...
        else if (this.props.position === exports.SpinnerPositionEnum.INLINE && !this.props.customSpinner) {
    ...
    getContent() {
        if (this.props.customSpinner) {
            ...
            return React.createElement("div", { className: `loader ${this.props.spinnerType || exports.SpinnerTypeEnum.DEFAULT}`, style: contentStyle });
        }
    }
    render() {
        const background = this.props.position !== exports.SpinnerPositionEnum.INLINE && React.createElement("div", { className: "background", style: { backgroundColor: this.props.backgroundColor || SPINNER_CONSTANTS.DEFAULT_COLORS.BACKGROUND } });
